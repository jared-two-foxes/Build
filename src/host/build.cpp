...
static void build_path( lua_State* L );
...
static void build_path( lua_State* L )
{
  ...
  lua_pushstring( L, ";" );
  lua_getglobal( L, "_USER_HOME_DIR" );
  lua_pushstring( L, "/Library/Application Support/build" );
#endif

  /* In the /usr tree */
  lua_pushstring( L, ";/usr/local/share/build;/usr/share/build" );
