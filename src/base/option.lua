...
--
	...
	function m.add(opt)
		...
		b.option.list[opt.trigger:lower()] = opt
...
--
	...
	function m.each()
		...
		local keys = { }
		for _, option in pairs(b.option.list) do
