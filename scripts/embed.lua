...
-- Prepare the file header
	...
	buffered.writeln(result, "/* Build's Lua scripts, as static data buffers for release mode builds */")
	buffered.writeln(result, "/* DO NOT EDIT - this file is autogenerated - see BUILD.txt */")
	buffered.writeln(result, "/* To regenerate this file, run: build embed */")
	buffered.writeln(result, "")
	buffered.writeln(result, '#include "host/build.h"')
	buffered.writeln(result, "")
...
-- Generate table of embedded content.
	...
	addScript(contentTable, path.join(_SCRIPT_DIR, "../src/_build_main.lua"), "src/_build_main.lua")
...
-- and only overwrite it if there are actual changes.
	...
	print("Writing...")
	local scriptsFile = path.getabsolute(path.join(_SCRIPT_DIR, "../src/scripts.cpp"))
